...
<div class="container-fluid">
    ...
    <table id="ctable" class="table table-striped table-hover" style="width:100%;">
        <thead>
            <tr>
                <th>CUSTOMER ID</th>
                <th>NAME</th>
...
<div class="modal-dialog">
    <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="cform" action="#" method="#" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input type="hidden" class="form-control id" id="cid" name="cid">
                    </div>
                    
                    <center><h4 id="labels" class="modal-title">CREATE NEW CUSTOMER</h4></center>
                    <center><h4 id="ilabels" class="modal-title">EDIT CUSTOMER PROFILE</h4></center>
        ...
        <div class="modal-footer" id="btnss">
            ...
            <button id="cSubmit" type="submit" class="btn btn-primary">Save</button>
            <button id="cUpdate" type="submit" class="btn btn-primary">Update</button>
        </div>
    </div>
</div>
</div>