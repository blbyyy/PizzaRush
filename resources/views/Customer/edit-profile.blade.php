...
{{ Form::model($customer,['route' => ['customer.cupdateprofile',$customer->id],'method'=> 'PUT','enctype'=>'multipart/form-data']) }}
                        ...
                        <div class="row gx-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control validate @error('gender') is-invalid @enderror" name="gender" id="gender" required autocomplete="gender">
                                        ...
                                        @enderror
                                        <option selected disabled hidden>{{ $customer->gender }}</option>
