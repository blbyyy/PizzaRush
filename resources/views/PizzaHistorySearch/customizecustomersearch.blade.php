...
<br>
        @if (isset($customorders))
            <div class="media-body">
                <p>Name: {{$customorders->name}}</p>
                <p>Email: {{$customorders->email}}</p>
                <p>Gender: {{$customorders->gender}}</p>
                <p>Address: {{$customorders->address}}</p>
                <p>BirthDate: {{$customorders->birthdate}}</p>
                <p>Phone: {{$customorders->phone}}</p>
            </div>
		@else
		@endif
<div class="table-wrapper">
    <table class="fl-table">
        ...
        <tr>
			...
			<th>PIZZA CRUST AVAILED</th>
            <th>PIZZA TOPPINGS AVAILED</th>
            <th>PRICE</th>
        </tr>
        </thead>
        <tbody>
