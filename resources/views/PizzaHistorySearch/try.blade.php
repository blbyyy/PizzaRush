...
<div class="directory-info-row">
                ...
                <div class="panel-body">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h5 style="color:white;"> Name: </h5> <h6><span class="text-muted small">{{$customorders->name}}</span></h6>
                            <h5 style="color:white;"> Gender: </h5> </h6><span class="text-muted small">{{$customorders->gender}}</span></h6>
                        </div>
						@else
						@endif
                    </div>
	...
	<div class="table">
		<div class="table-header">
			<div class="header__item"><a id="wins" class="filter__link filter__link--number" href="#">TRANSACTION DATE</a></div>
			<div class="header__item"><a id="wins" class="filter__link filter__link--number" href="#">PIZZA CRUST AVAILED</a></div>
            <div class="header__item"><a id="wins" class="filter__link filter__link--number" href="#">PIZZA TOPPINGS AVAILED</a></div>
		...
		<div class="table-content">	
			 ...
			 @if (isset($order))
			<div class="table-row">		
				<div class="table-data"><span>{{$order->ordered_date}}</span></div>
				<div class="table-data"><span>{{$order->PCname}}</span></div>
                <div class="table-data"><span>{{$order->PTname}}</span></div>
				<div class="table-data"><span>{{$order->total}}</span></div>
			</div>
			@else
			@endif
			@endforeach
