        ...
        <div class="container">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-6 col-sm-12 ftco-animate">
			  ...
			  <p>
				<a href="{{ route('pizza.addToCart', ['id'=>$pizzass->id]) }}" class="btn btn-primary p-3 px-xl-4 py-xl-3">Order Now</a> 
				<a href="{{ url('pizzaindex') }}" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">View Menu</a>
			  </p>
            </div>
